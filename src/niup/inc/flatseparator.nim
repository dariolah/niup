...
## IUP class: FlatSeparator
##
## NIUP type: FlatSeparator_t
##
## constructors
##
##    proc FlatSeparator(): FlatSeparator_t
##
...
proc `barsize=`*(ih: FlatSeparator_t, value: string) {.cdecl.} =
    ## BARSIZE (non inheritable): controls the size of the separator
    ## in the opposite direction of its orientation. Default: 5.
