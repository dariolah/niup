...
## IUP class: FlatFrame
##
## NIUP type: FlatFrame_t
##
## constructors
##
##    proc FlatFrame(child: IUPhandle_t): FlatFrame_t
##
...
proc `frame=`*(ih: FlatFrame_t, value: string) {.cdecl.} =
    ...
    ## CROSSTITLE is used TITLELINE and TITLEALIGNMENT are ignored,
    ## the title line is never drawn and alignment is always left.
